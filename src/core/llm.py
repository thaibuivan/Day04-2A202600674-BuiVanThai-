...
# 1 request every 8 seconds = ~7.5 RPM, safely under the 10 RPM free-tier limit
    ...
    *,
    ...
    if provider == "fireworks":
        ...
        return ChatFireworks(
            model=model_name or "accounts/fireworks/models/kimi-k2p6",
            temperature=temperature,
            fireworks_api_key=os.getenv("FIREWORKS_API_KEY"),
        )
    raise ValueError("This lab supports only the `google`, `ollama`, `groq`, and `fireworks` providers.")
